...
const solutions = [
  ...
  },
  {
    ...
    description:
      "Get custom-built mobile apps using React Native or Flutter for Android and iOS, optimized for performance and UX.",
      ...
      {solutions.map((item, index) => (
        ...
        >
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1e3e62] dark:text-white mb-4">
              {item.title}
            </h2>
